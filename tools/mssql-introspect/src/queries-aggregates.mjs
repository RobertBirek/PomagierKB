...
SELECT (SELECT COUNT(*) FROM sl_GrupaKh) AS groups_defined,
  ...
  // w sprzedaży" bez sięgania do bazy na żywo (2026-09-23, pytanie z panelu bez odpowiedzi).
  {
    ...
    description: 'Gotowa lista najlepiej sprzedających się produktów (top 10 / top 20 produktów, bestsellery, hity sprzedaży) w instancji: towary uszeregowane po sprzedaży netto z ostatnich 12 miesięcy, z symbolem, nazwą, ilością i liczbą dokumentów. Odpowiada wprost na pytanie: jakie są top 10 produktów w sprzedaży — weź pierwsze 10 pozycji listy.',
    kind: 'products',
    shape: 'grouped',
...
ORDER BY net_sales DESC`,
  },
  {
    ...
    description: 'Ile zarobiliśmy (przychód netto ze sprzedaży) w poszczególnych dniach ostatnich dwóch tygodni przed odświeżeniem — do pytań: ile sprzedaliśmy wczoraj, ile w tym tygodniu. Dzisiejszego dnia baza nie zna (fakt na żywo — zapytanie SQL z szablonu przychodu dziennego).',
    kind: 'documents',
    shape: 'grouped',
